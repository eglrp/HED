...
class HF_FCN(nn.Module):
    def __init__(self,num_filters=32,class_number=2):
        super().__init__()
        ...
        self.dconv2_2=nn.Conv2d(num_filters*4,1,1,1)
        # 1/4
        self.conv3_1=encoder[10:12]
        self.dconv3_1=nn.Conv2d(num_filters*8,1,1,1)
        self.conv3_2=encoder[12:14]
        self.dconv3_2=nn.Conv2d(num_filters*8,1,1,1)
        self.conv3_3=encoder[14:16]
        self.dconv3_3=nn.Conv2d(num_filters*8,1,1,1)
        # 1/8
        self.conv4_1=encoder[17:19]
        self.dconv4_1=nn.Conv2d(num_filters*16,1,1,1)
        self.conv4_2=encoder[19:21]
        self.dconv4_2=nn.Conv2d(num_filters*16,1,1,1)
        self.conv4_3=encoder[21:23]
        self.dconv4_3=nn.Conv2d(num_filters*16,1,1,1)
        # 1/16
        self.conv5_1=encoder[24:26]
        self.dconv5_1=nn.Conv2d(num_filters*16,1,1,1)
        self.conv5_2=encoder[26:28]
        self.dconv5_2=nn.Conv2d(num_filters*16,1,1,1)
        self.conv5_3=encoder[28:30]
        self.dconv5_3=nn.Conv2d(num_filters*16,1,1,1)
...
def hf_fcn(class_number=5):
    model=HF_FCN(class_number=class_number)
    return model
